...
def main():
    ...
    axes[0,0].set_title(f"1-day forecast: HAR evs={results[1]['model']['explainedvariancescore']:0.2E}, Bench evs={results[1]['bench']['explainedvariancescore']:0.2E}")
    ...
    axes[0,1].set_title(f"5-day forecast: HAR evs={results[5]['model']['explainedvariancescore']:0.2E}, Bench evs={results[5]['bench']['explainedvariancescore']:0.2E}")
    axes[0,1].legend()
    ...
    axes[1,0].set_title(f"10-day forecast: HAR evs={results[10]['model']['explainedvariancescore']:0.2E}, Bench evs={results[10]['bench']['explainedvariancescore']:0.2E}")
    axes[1,0].legend()
    ...
    axes[1,1].set_title(f"20-day forecast: HAR evs={results[20]['model']['explainedvariancescore']:0.2E}, Bench evs={results[20]['bench']['explainedvariancescore']:0.2E}")
    axes[1,1].legend()
    fig.tight_layout()
